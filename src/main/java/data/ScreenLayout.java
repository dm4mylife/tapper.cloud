...
public class ScreenLayout {
    ...
    public static class Tapper {

        public static final String tapperTableEmpty = "tapper_table_empty";
        ...
        public static final String tapperTableWithDiscountAndZeroPriceDishOrderPartTwo =
                "tapper_table_with_discount_and_zero_price_dish_part2";
        public static final String wifiIcon = "table_with_wifi";
        public static final String openedWifi = "table_with_opened_wifi";
        public static final String openedCallWaiterWithReceiptMessagePartOne =
                "opened_call_waiter_with_receipt_message_part1";
        public static final String openedCallWaiterWithReceiptMessagePartTwo =
                "opened_call_waiter_with_receipt_message_part2";
        ...
        public static final String reviewNegative = "review_negative";
        ...
        public static final String reviewPage = "review_page";
    ...
    public static class AdminPersonalAccount {
        ...
        public static final String historyOperationsMonthFilter = "admin_history_operations_month_filter";
        public static final String requisites = "admin_requisites";
        public static final String adminMenu = "admin_admin_menu";
        public static final String adminMenuNTooltip = "admin_admin_menu_tooltip";
        public static final String configNotifications = "admin_config_notifications";

    }

    public static class SupportPersonalAccount {

        public static final String rootPage = "support_root_page";
        public static final String profilePart = "support_profile";
        public static final String openedLeftMenu = "support_opened_left_nav_menu";
        public static final String restaurantSearch = "support_restaurant_search";
        public static final String logsAndPermissions = "support_admin_logs_and_permissions";

    }

    public static class WaiterPersonalAccount {

        public static final String profilePartOne = "waiter_profile_part1";
        public static final String profilePartTwo = "waiter_profile_part2";
