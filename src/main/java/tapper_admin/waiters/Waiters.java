...
import static constants.TapperAdminSelectors.RKeeperAdmin.Waiters.waiterStatusInCard;
import static constants.TapperAdminSelectors.RKeeperAdmin.pageHeading;
import static constants.TapperAdminSelectors.RKeeperAdmin.waiterMenuCategory;
...
public class Waiters extends BaseActions {
    ...
    public void isWaiterCategoryCorrect() {
        ...
        pagePreloader.shouldHave(cssValue("display","none"),Duration.ofSeconds(5));
