...
public class SelectorsTapperTable {
    ...
    public static class RootPage {
        ...
        public static class TipsAndCheck {
            ...
            public static final SelenideElement discountContainer =
                    $x("//*[@class='check__tips'][./*[@class='check__tips-heading'][text()='Скидка:']]");
            public static final SelenideElement discountSum =
                    $x("//*[@class='check__tips-heading'][text()='Скидка:']/following-sibling::span");
            public static final SelenideElement markupContainer =
                    $x("//*[@class='check__tips-heading'][text()='Наценка:']");
