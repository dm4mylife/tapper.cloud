...
public class SelectorsTapperTable {
    ...
    public static class RootPage {
        ...
        public static class DishList {
            ...
            public static final SelenideElement menuDishesContainer = $(".mainPage__content .orderList");
        ...
        public static class TapBar {
            ...
            public static final SelenideElement appFooterMenuIcon = $(".appFooter__btn>svg.iconMenu");
            public static final SelenideElement appFooterWalletIcon = $(".appFooter__btn>svg.iconCreditCard");
