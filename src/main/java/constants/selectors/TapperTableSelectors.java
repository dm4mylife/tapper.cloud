...
public class TapperTableSelectors {
    ...
    public static class RootPage {
        ...
        public static class DishList {
            ...
            public static final SelenideElement separateOrderHeading =
                    $(".mainPage__content .separateOrderText");
            ...
            public static final ElementsCollection allNonPaidAndNonDisabledDishes =
                $$x("//*[@class='orderItem']" +
                        "[./*[@class='orderItem__status' and not(contains(text(),'Оплачивается'))]]");
            ...
            public static final ElementsCollection disabledAndPaidDishes =
                $$x("//*[contains(@class,'orderItem')]" +
                        "[./*[@class='orderItem__status' and not(contains(text(),'Не оплачено'))]]");
        ...
        public static class TipsAndCheck {
            ...
            public static final SelenideElement tipsInCheckField =
                $x("//*[@class='orderTotal']" +
                        "//*[@class='orderTotal__row'][.//*[contains(text(),'Чаевые')]]");
            ...
            public static final SelenideElement anotherGuestSumField =
                $x("//*[@class='orderTotal']" +
                        "//*[@class='orderTotal__row'][.//*[contains(text(),'Другой пользователь')]]");
            public static final SelenideElement anotherGuestSum =
                $x("//*[@class='orderTotal']" +
                        "//*[contains(text(),'Другой пользователь')]/following-sibling::span");
            public static final SelenideElement markedDishesField =
                $x("//*[@class='orderTotal']" +
                        "//*[@class='orderTotal__row'][.//*[contains(text(),'Отмеченные позиции')]]");
            public static final SelenideElement markedDishesSum =
                $x("//*[@class='orderTotal']" +
                        "//*[contains(text(),'Отмеченные позиции')]/following-sibling::span");
            public static final SelenideElement discountField =
                $x("//*[@class='orderTotal']" +
                        "//*[@class='orderTotal__row'][.//*[contains(text(),'Скидка')]]");
            ...
            public static final SelenideElement markupField =
                $x("//*[@class='orderTotal']" +
                        "//*[@class='orderTotal__row'][.//*[contains(text(),'Наценка')]]");
            ...
            public static final SelenideElement activeTipsButton =
                    $(".waiter__percents .waiterTipsPercent.active");
            ...
            public static final SelenideElement totalPay =
                $x("//*[contains(@class,'orderTotal__row')]" +
                        "/span[text()=\"Итого к оплате:\"]/following-sibling::span");
        ...
        public static class PayBlock {
            ...
            public static final SelenideElement checkContainer =
                    $(".orderTotal");
            public static final SelenideElement paymentButton =
                    $x("//*[@class='mainPage']//button[contains(text(),'Оплатить')]");
            public static final SelenideElement serviceChargeContainer =
                    $(".serviceFee");
            public static final SelenideElement serviceChargeCheckbox =
                    $(".serviceFee__checkbox .baseClickedCheckbox svg");
            public static final SelenideElement paymentMethodsContainer =
                    $(".payedVariants");
            public static final ElementsCollection paymentMethods =
                    $$(".payedVariants img");
            public static final SelenideElement confPolicyContainer =
                    $(".mainPage .privacyPolicyModal");
            public static final SelenideElement confPolicyContent =
                    $(".mainPage .privacyPolicyModal__content");
            public static final SelenideElement confPolicyLink =
                    $(".mainPage .privacyPolicy .privacyPolicy__text");
            public static final SelenideElement shareButton =
                    $x("//*[@class='mainPage']//button[text()='Поделиться счетом']");
        ...
        public static class Menu {
            ...
            public static final ElementsCollection dishesInCategoryContainer =
                    $$x("//*[@class='orderMenuList']//*[@class='orderMenuList__item']" +
                            "[.//*[contains(text(),'новая группа')]]//*[@class='orderMenuProductList__item']");
    ...
    public static class ReviewPage {
        ...
        public static final SelenideElement paymentProcessGifProcessing =
                $(".paymentProcess .paymentProcess__gif img[src*='process_gif']");
        public static final SelenideElement paymentProcessGifSuccess =
                $(".paymentProcess .paymentProcess__gif img[src*='process_yes']");
        ...
        public static final SelenideElement commentHeading =
                $(".reviewModal__comments .reviewModal__comments-title");
        ...
        public static final SelenideElement review5Stars =
                $(".reviewModal__stars .reviewModal__stars-item:nth-child(5)");
        public static final SelenideElement review1Stars =
                $(".reviewModal__stars .reviewModal__stars-item:nth-child(1)");
        public static final SelenideElement whatDoULikeList =
                $(".reviewModal__common .reviewModal__ratng-list");
        ...
        public static final SelenideElement suggestionHeading =
                $(".reviewModal__suggestions .reviewModal__suggestions-title");
