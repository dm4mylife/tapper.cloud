package tapper.tests.screenshots_comparison.diff_image.admin_personal_account;
...
import tests.DiffImageBaseDesktopOnlyTest;
import tests.DiffImageBaseTest;
...
@Story("Текущий - Пустой стол")
@DisplayName("Текущий - Пустой стол")

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class TapperMenuTest extends DiffImageBaseDesktopOnlyTest {
    ...
    boolean isScreenShot = DiffImageBaseDesktopOnlyTest.isScreenShot;
    double diffPercent = DiffImageBaseDesktopOnlyTest.diffScreenPercent;
    int imagePixelSize = DiffImageBaseDesktopOnlyTest.imagePixelSize;
