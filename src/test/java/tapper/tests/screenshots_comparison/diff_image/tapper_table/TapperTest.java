package tapper.tests.screenshots_comparison.diff_image.tapper_table;
...
public class TapperTest extends DiffImageBaseTest {
    ...
    boolean isScreenShot = DiffImageBaseTest.isScreenShot;
    double diffPercent = DiffImageBaseTest.diffScreenPercent;
    int imagePixelSize = DiffImageBaseTest.imagePixelSize;
