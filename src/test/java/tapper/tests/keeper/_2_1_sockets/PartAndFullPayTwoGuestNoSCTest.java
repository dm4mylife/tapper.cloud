...
@Epic("RKeeper")
@Feature("Сокеты")
@Story("Частичная оплата с 1-го устройства и полная со 2-го устройства без сервисного сбора")
@DisplayName("Частичная оплата с 1-го устройства и полная со 2-го устройства  без сервисного сбора")


@TestMethodOrder(MethodOrderer.DisplayName.class)
class PartAndFullPayTwoGuestNoSCTest extends TwoBrowsers {
    ...
    @Test
    @DisplayName("1.3. Выбираем рандомно блюда у первого гостя, сохраняем данные для след.теста. Отключаем сервисный сбор")
    ...
    @Test
    @DisplayName("1.9. Сохраняем платежные данные второго гостя")
    ...
    @Test
    @DisplayName("2.2. Проверяем у первого и второго гостя пустые столы")
    void switchTo2GuestAndCheckPaidDishes() {
        ...
        apiRKeeper.isPrepaymentSuccessOnlyKeeper(guid,WAIT_FOR_PREPAYMENT_DELIVERED_TO_CASH_DESK);
