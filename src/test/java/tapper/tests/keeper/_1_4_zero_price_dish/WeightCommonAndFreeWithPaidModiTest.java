...
@Story("Порционные по весу. Порционная позиция стоимостью 0р и платными модификаторами")
@DisplayName("Порционные по весу. Порционная позиция стоимостью 0р и платными модификаторами")

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class WeightCommonAndFreeWithPaidModiTest extends BaseTest {
