...
@Story("Порционные по весу. Порционная позиция стоимостью 0р и платными модификаторами и со скидкой")
@DisplayName("Порционные по весу. Порционная позиция стоимостью 0р и платными модификаторами и со скидкой")

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class WeightCommonAndFreeWithPaidModiWithDiscountTest extends BaseTest {
