...
import static api.ApiData.OrderData.WAITER_NON_CARD_NEVER_INVITED;

@Epic("RKeeper")
@Feature("Официант")
@Story("Официант не верифицирован, c привязанной картой, не был никогда приглашен, полная оплата")
@DisplayName("Официант не верифицирован, c привязанной картой, не был никогда приглашен, полная оплата")

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class NonVerifiedNoCardNonInvitedTest extends BaseTest {
    ...
    protected final String waiter = WAITER_NON_CARD_NEVER_INVITED;
