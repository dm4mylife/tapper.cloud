...
@Feature("keeper - оплата, разделяя счёт по позиции до самого конца - обычные - чай+сбор")
@DisplayName("keeper - оплата, разделяя счёт по позиции до самого конца - обычные - чай+сбор")

@TestMethodOrder(MethodOrderer.DisplayName.class)

public class _1_2_DivideAndPayTillEndTest extends BaseTest {
    ...
    public void createAndFillOrder() {
        ...
        apiRKeeper.fillingOrder(rqParamsFillingOrderBasic(R_KEEPER_RESTAURANT, visit, BARNOE_PIVO, "9000"));
    ...
    @Test
    @DisplayName("7. Разделяем счёт, оплачиваем одну позицию и так пока весь заказ не будет оплачен")
    public void payTillEnd() {

        rootPageNestedTests.payTillFullSuccessPayment(3);
