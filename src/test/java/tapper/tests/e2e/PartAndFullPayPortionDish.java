...
@Feature("keeper - частичная\\полная оплата - рандом поз порционная - чай+сбор - карта - отзыв")
@DisplayName("keeper - частичная\\полная оплата - рандом поз порционная - чай+сбор - карта - отзыв")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)

public class PartAndFullPayPortionDish extends BaseTest {
    ...
    public void createAndFillOrder() {
        ...
        apiRKeeper.fillingOrder(rqParamsFillingOrderBasic(R_KEEPER_RESTAURANT,visit,GOVYADINA_PORTION,"2000"));
    ...
    @Test
    @Order(7)
    @Step("Разделяем счёт, оплачиваем одну позицию и так пока весь заказ не будет оплачен")
    @DisplayName("Разделяем счёт, оплачиваем одну позицию и так пока весь заказ не будет оплачен")
