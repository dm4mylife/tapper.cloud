...
@Feature("keeper - частичная оплата - обычные позиции - без чая и без сбора - карта - отзыв")
@DisplayName("keeper - частичная оплата - обычные позиции - без чая и бес сбора - карта - отзыв")
