...
@Feature("keeper - полная оплата по кнопке 'Оплатить' - позиции со скидками - чай+сбор")
@DisplayName("keeper - полная оплата по кнопке 'Оплатить' - позиции со скидками - чай+сбор")

@TestMethodOrder(MethodOrderer.DisplayName.class)
public class _0_5_Discont extends BaseTest {
    ...
    @Test
    @DisplayName("3. Проверка суммы, чаевых, сервисного сбора, скидки")
