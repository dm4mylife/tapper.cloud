package tapper.tests.iiko._2_1_stress;
...
@Story("Полная оплата (стресс-тест, 100 позиций)")
@DisplayName("Полная оплата (стресс-тест, 100 позиций)")

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class BigOrderFullPayTest extends BaseTest {
