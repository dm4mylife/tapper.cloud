...
class FullPayZeroPriceAndPaidModiTest extends BaseTest {
    ...
    void createAndFillOrder() {
        ...
        apiIiko.createModificatorObject
                (dishesForFillingOrder, ZERO_PRICE_DISH_TEA_PAID_NOT_NECESSARY_MODIFIER.getId(), 1);
    ...
    @Test
    @Order(2)
    @DisplayName("Проверка суммы, чаевых, сервисного сбора. Сбрасываем чаевые")
    void checkSumTipsSC() {
