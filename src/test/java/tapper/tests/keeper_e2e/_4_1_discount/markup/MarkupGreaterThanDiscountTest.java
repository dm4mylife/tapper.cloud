package tapper.tests.keeper_e2e._4_1_discount.markup;
...
@Epic("RKeeper")
@Feature("Наценка")
@Story("Полная оплата. Скидка меньше наценки")
@DisplayName("Полная оплата. Скидка меньше наценки")

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class MarkupGreaterThanDiscountTest extends BaseTest {
    ...
    static String discountAmount = "50000";
    static String markupAmount = "20000";
    ...
    void checkIsDiscountPresent() {
        ...
        rootPageNestedTests.checkIsMarkupPresent(tableId, "keeper");

        Assertions.assertEquals
                (100, rootPage.convertSelectorTextIntoDoubleByRgx(markupSum,discountInCheckRegex));
