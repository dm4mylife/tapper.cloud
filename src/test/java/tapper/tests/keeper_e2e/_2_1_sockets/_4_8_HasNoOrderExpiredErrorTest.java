...
public class _4_8_HasNoOrderExpiredErrorTest extends BaseTest {
    ...
    public void goToAcquiringAndWaitTillTransactionExpired() {
        ...
        transactionId = nestedTests.goToAcquiringAndWaitTillTransactionExpired(totalPay, WAIT_UNTIL_TRANSACTION_STILL_ALIVE);
