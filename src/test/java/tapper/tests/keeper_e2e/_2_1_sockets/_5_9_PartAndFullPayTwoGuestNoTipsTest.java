...
@Epic("RKeeper")
@Feature("Сокеты")
@Story("Частичная оплата с 1-го устройства и полная со 2-го устройства без чаевых")
@DisplayName("Частичная оплата с 1-го устройства и полная со 2-го устройства без чаевых")


@TestMethodOrder(MethodOrderer.DisplayName.class)
public class _5_9_PartAndFullPayTwoGuestNoTipsTest extends BaseTestTwoBrowsers {
