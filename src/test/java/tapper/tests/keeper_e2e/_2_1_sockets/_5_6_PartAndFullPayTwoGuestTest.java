...
@Epic("RKeeper")
@Feature("Сокеты")
@Story("Частичная оплата на 1одном устройстве, и оплата оставшихся позиций на втором устройстве. " +
        "У обоих должен быть пустой стол по окончанию")
@DisplayName("Частичная оплата на 1одном устройстве, и оплата оставшихся позиций на втором устройстве. " +
        "У обоих должен быть пустой стол по окончанию")


@TestMethodOrder(MethodOrderer.DisplayName.class)
public class _5_6_PartAndFullPayTwoGuestTest extends BaseTestTwoBrowsers {
