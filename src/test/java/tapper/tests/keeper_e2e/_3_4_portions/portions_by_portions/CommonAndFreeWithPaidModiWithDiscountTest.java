package tapper.tests.keeper_e2e._3_4_portions.portions_by_portions;
...
@Epic("RKeeper")
@Feature("Порционные за отдельную порцию")
@Story("Порционная позиция стоимостью 0р и платными модификаторами и со скидкой")
@DisplayName("Порционная позиция стоимостью 0р и платными модификаторами и со скидкой")

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class CommonAndFreeWithPaidModiWithDiscountTest extends BaseTest {
    ...
    String portionDish = FREE_WEIGHT_BY_PORTION_DISH;
