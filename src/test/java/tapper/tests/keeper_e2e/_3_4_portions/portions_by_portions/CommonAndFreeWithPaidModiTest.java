...
@Story("Порционная позиция стоимостью 0р и платными модификаторами")
@DisplayName("Порционная позиция стоимостью 0р и платными модификаторами")

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class CommonAndFreeWithPaidModiTest extends BaseTest {
