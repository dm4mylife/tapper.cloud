...
public class _8_0_PartPayDiscountTest extends BaseTest {
    ...
    public void createAndFillOrder() {
        ...
        Response rs = rootPageNestedTests.createOrder(R_KEEPER_RESTAURANT, TABLE_CODE_444,WAITER_ROBOCOP_VERIFIED_WITH_CARD,
                AUTO_API_URI,TABLE_AUTO_444_ID);
    ...
    @Test
    @DisplayName("2. Проверка суммы, чаевых, сервисного сбора. Устанавливаем сервисный сбор")
    public void checkSumTipsSC() {

        rootPageNestedTests.chooseDishesWithRandomAmount(amountDishesToBeChosen);

        discount = rootPageNestedTests.getDiscount(TABLE_AUTO_444_ID);
