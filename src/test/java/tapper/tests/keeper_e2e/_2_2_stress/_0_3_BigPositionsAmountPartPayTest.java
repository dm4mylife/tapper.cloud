...
@Story("Частичная оплата (стресс-тест, 100 позиций)")
@DisplayName("Частичная оплата (стресс-тест, 100 позиций)")

@TestMethodOrder(MethodOrderer.DisplayName.class)

public class _0_3_BigPositionsAmountPartPayTest extends BaseTest {
    ...
    static int amountDishesToBeChosen = 35;
    static int amountDishesForFillingOrder = 100;
    ...
    public void createAndFillOrder() {
        ...
        Response rs = rootPageNestedTests.createAndFillOrderAndOpenTapperTable
                (R_KEEPER_RESTAURANT, TABLE_CODE_222,WAITER_ROBOCOP_VERIFIED_WITH_CARD,
    ...
    public void chooseDishesAndCheckAfterDivided() {
        ...
        rootPageNestedTests.chooseDishesWithRandomAmountWithBigAmountDishes(amountDishesToBeChosen);
