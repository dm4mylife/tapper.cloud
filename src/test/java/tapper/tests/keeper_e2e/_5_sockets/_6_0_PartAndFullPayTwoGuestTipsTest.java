...
@Epic("RKeeper")
@Feature("Сокеты")
@Story("Частичная оплата с 1-го устройства и полная со 2-го устройства c чаевыми")
@DisplayName("Частичная оплата с 1-го устройства и полная со 2-го устройства c чаевыми")


@TestMethodOrder(MethodOrderer.DisplayName.class)
public class _6_0_PartAndFullPayTwoGuestTipsTest extends BaseTestTwoBrowsers {
