...
public class _6_5_NonVerifiedFullNoCardNoScTest extends BaseTest {
    ...
    public void createAndFillOrder() {
        ...
        Response rs = apiRKeeper.createOrder(rqParamsCreateOrderBasic(R_KEEPER_RESTAURANT, TABLE_3, WAITER_IRONMAN_NON_VERIFIED_NON_CARD));
    ...
    @Test
    @DisplayName("3. Проверка суммы, отсутствия чаевых, корректности сервисного сбора")
    public void checkSumTipsSC() {

        double cleanDishesSum = rootPage.countAllNonPaidDishesInOrder();
        rootPageNestedTests.checkSumWithAllConditionsWithNoVerifiedWaiter(cleanDishesSum);
