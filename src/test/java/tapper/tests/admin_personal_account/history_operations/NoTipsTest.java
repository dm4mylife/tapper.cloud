...
@Story("Частичная и полная оплата без чаевых, проверка их в историях операций")
@DisplayName("Частичная и полная оплата без чаевых, проверка их в историях операций")

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class NoTipsTest extends BaseTest {
