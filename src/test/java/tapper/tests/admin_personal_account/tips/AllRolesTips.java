...
@Feature("Чаевые")
@DisplayName("Отправка чаевых официанту/кальянщику/кухне")

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class AllRolesTips extends PersonalAccountTest {
    ...
    @Test
    @Order(7)
    @DisplayName("Выставляем чаевые кухне")
    void setKitchenTipsTips() {

        totalTips += rootPage.setCertainTipsOption(kitchenRole,tips10);
        kitchenTips = rootPage.getCurrentTipsSum();
    ...
    void isTotalTipsCorrect() {
        ...
        Assertions.assertEquals(totalTips, waiterTips + hookahTips + kitchenTips,
